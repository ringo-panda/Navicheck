class ApplicationController < ActionController::Base
  ...
  def after_sign_in_path_for(resource)
    if resource.sign_in_count == 1
      ...
      SelectionStatus.create(status_name: "インターン申し込み前", user_id: resource.id, edit_permission: false)
      ...
      SelectionStatus.create(status_name: "会社説明会申し込み前", user_id: resource.id, edit_permission: false)
